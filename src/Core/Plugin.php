...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( PekShipmentRequestBuilder::class, fn(): PekShipmentRequestBuilder => new PekShipmentRequestBuilder( $this->container->get( PekSettings::class ), $this->container->get( PekShipmentDeclaredValueResolver::class ), $this->container->get( PekShipmentSenderWarehouseResolver::class ), $this->container->get( PekShipmentCargoBuilder::class ), $this->container->get( PekShipmentRecipientBuilder::class ), $this->container->get( PekShipmentCorrelationResolver::class ), $this->container->get( PekSmsReleaseAvailabilityService::class ) ) );
		...
		$this->container->register( PekShipmentService::class, fn(): PekShipmentService => new PekShipmentService( $this->container->get( PekApiClient::class ), $this->container->get( PekShipmentStatusService::class ), $this->container->get( OrderShipmentRepository::class ), $this->container->get( PekShipmentButtonPolicy::class ) ) );
