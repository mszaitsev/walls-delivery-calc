...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( DpdCityResolver::class, fn(): DpdCityResolver => new DpdCityResolver( $this->container->get( LocationCarrierCodeRepository::class ), $this->container->get( DpdApiClient::class ), $this->container->get( DpdDuplicateCityResolver::class ) ) );
