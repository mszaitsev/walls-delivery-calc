...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( PekSenderCounterpartService::class, fn(): PekSenderCounterpartService => new PekSenderCounterpartService( $this->container->get( PekApiClient::class ), $this->container->get( PekPrivateAccessTokenService::class ), $this->container->get( PekSettings::class ) ) );
		$this->container->register( PekSmsReleaseAvailabilityService::class, fn(): PekSmsReleaseAvailabilityService => new PekSmsReleaseAvailabilityService( $this->container->get( PekApiClient::class ), $this->container->get( PekPrivateAccessTokenService::class ), $this->container->get( PekSettings::class ) ) );
		...
		$this->container->register( PekShipmentDestinationResolver::class, fn(): PekShipmentDestinationResolver => new PekShipmentDestinationResolver( $this->container->get( PekPickupPointProvider::class ), $this->container->get( PekLocationResolver::class ) ) );
		...
		$this->container->register( PekShipmentRecipientBuilder::class, fn(): PekShipmentRecipientBuilder => new PekShipmentRecipientBuilder() );
		...
		$this->container->register( PekShipmentButtonPolicy::class, fn(): PekShipmentButtonPolicy => new PekShipmentButtonPolicy() );
		$this->container->register( PekShipmentService::class, fn(): PekShipmentService => new PekShipmentService( $this->container->get( PekApiClient::class ), $this->container->get( PekShipmentStatusService::class ), $this->container->get( OrderShipmentRepository::class ), $this->container->get( PekShipmentButtonPolicy::class ), $this->container->get( ShipmentActualCostService::class ), $this->container->get( PekStatusMapping::class ) ) );
		...
		$this->container->register( PekShipmentAdapter::class, fn(): PekShipmentAdapter => new PekShipmentAdapter( $this->container->get( PekApiClient::class ), $this->container->get( PekShipmentRequestBuilder::class ), $this->container->get( PekShipmentStatusService::class ), $this->container->get( PekShipmentService::class ), $this->container->get( PekShipmentButtonPolicy::class ), $this->container->get( PekShipmentCreateResponseParser::class ), $this->container->get( ShipmentActualCostResolver::class ), $this->container->get( Logger::class ) ) );
		...
		$this->container->register( JetLogisticStatusService::class, fn(): JetLogisticStatusService => new JetLogisticStatusService( $this->container->get( JetLogisticApiClient::class ), $this->container->get( JetLogisticStatusMapper::class ) ) );
		...
		$this->container->register( JetLogisticShipmentService::class, fn(): JetLogisticShipmentService => new JetLogisticShipmentService( $this->container->get( OrderShipmentRepository::class ), $this->container->get( JetLogisticStatusService::class ) ) );
		...
		$this->container->register( CdekOrderStatusService::class, fn(): CdekOrderStatusService => new CdekOrderStatusService( $this->container->get( OrderShipmentRepository::class ), $this->container->get( CdekApiClient::class ), $this->container->get( ShipmentActualCostResolver::class ), $this->container->get( ShipmentActualCostService::class ), $this->container->get( Logger::class ), $this->container->get( CdekStatusMappingService::class ) ) );
		...
		$this->container->register( OrderDeliveryReplacementService::class, fn(): OrderDeliveryReplacementService => new OrderDeliveryReplacementService( $this->container->get( OrderShipmentRepository::class ), $this->container->get( DeliveryDateFormatter::class ), $this->container->get( DeliveryCalculationDataBuilder::class ) ) );
