...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( PackagingBuilderConfig::class, fn(): PackagingBuilderConfig => new PackagingBuilderConfig( $this->container->get( DpdSettings::class )->tariff_default_weight_g(), $this->container->get( DpdSettings::class )->tariff_default_length_cm(), $this->container->get( DpdSettings::class )->tariff_default_width_cm(), $this->container->get( DpdSettings::class )->tariff_default_height_cm(), $this->container->get( DpdSettings::class )->tariff_default_declared_value_rub() ) );
		...
		$this->container->register( DpdQuoteCarrier::class, fn(): DpdQuoteCarrier => new DpdQuoteCarrier( $this->container->get( DpdSettings::class ), $this->container->get( DpdTariffCalculationService::class ), $this->container->get( PackagingBuilder::class ), $this->container->get( Logger::class ), $this->container->get( CheckoutSessionManager::class ) ) );
