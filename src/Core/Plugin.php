...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( ShipmentCreationService::class, fn(): ShipmentCreationService => new ShipmentCreationService( $this->container->get( OrderShipmentRepository::class ), array( $this->container->get( RussianPostShipmentAdapter::class ), $this->container->get( CdekShipmentAdapter::class ) ), $this->container->get( Logger::class ), $this->container->get( RussianPostShipmentActualCostLookupService::class ), $this->container->get( CarrierShipmentAdapterRegistry::class ) ) );
