...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( PekShipmentAdapter::class, fn(): PekShipmentAdapter => new PekShipmentAdapter( $this->container->get( PekApiClient::class ), $this->container->get( PekShipmentRequestBuilder::class ), $this->container->get( PekShipmentStatusService::class ), $this->container->get( PekShipmentService::class ), $this->container->get( PekShipmentButtonPolicy::class ), $this->container->get( PekShipmentCreateResponseParser::class ), $this->container->get( ShipmentActualCostResolver::class ), $this->container->get( Logger::class ), $this->container->get( PekCountryPolicy::class ) ) );
		...
		$this->container->register( OrderDeliveryRecalculationAdminController::class, fn(): OrderDeliveryRecalculationAdminController => new OrderDeliveryRecalculationAdminController( $this->container->get( OrderDeliveryRecalculationService::class ), $this->container->get( OrderDeliveryRateRenderer::class ), $this->container->get( CheckoutLocationAjax::class ), $this->container->get( RussianPostPickupPointRepository::class ), $this->container->get( OrderDeliveryAddressNormalizationService::class ), $this->container->get( OrderDeliveryReplacementService::class ), $this->container->get( YandexDeliveryCheckoutPickupPointFormatter::class ), $this->container->get( SettingsRepository::class ), $this->container->get( RussianPostPickupPointTypeSettings::class ), $this->container->get( DpdPickupPointScheduleFormatter::class ), $this->container->get( CarrierPickupPointProviderRegistry::class ), $this->container->get( PekCheckoutQuoteContextResolver::class ), $this->container->get( PekCheckoutPickupPointFormatter::class ), $this->environment->plugin_url(), $this->environment->version(), $this->container->get( CdekDeliveryPointService::class ), $this->container->get( DpdPickupPointService::class ), $this->container->get( YandexDeliveryPickupPointV2Repository::class ), $this->container->get( YandexLocationMappingV2Repository::class ) ) );
