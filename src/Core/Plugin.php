...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( CheckoutPickupPointRestController::class, fn(): CheckoutPickupPointRestController => new CheckoutPickupPointRestController( $this->container->get( RussianPostPickupPointRepository::class ), $this->container->get( CheckoutSessionManager::class ), $this->container->get( PickupPointLocationResolver::class ), $this->container->get( CdekDeliveryPointService::class ), $this->container->get( DpdPickupPointService::class ) ) );
		...
		$this->container->register( YandexDeliverySettings::class, fn(): YandexDeliverySettings => new YandexDeliverySettings( $this->container->get( SettingsRepository::class ), $this->container->get( EncryptionService::class ) ) );
		...
		$this->container->register( YandexLocationMapperV2Service::class, fn(): YandexLocationMapperV2Service => new YandexLocationMapperV2Service( $this->container->get( YandexLocationMappingV2Repository::class ), null, null, $this->container->get( YandexRegionMappingV2Repository::class ) ) );
		...
		$this->container->register( YandexDeliveryGeoCoverageService::class, fn(): YandexDeliveryGeoCoverageService => new YandexDeliveryGeoCoverageService( $this->container->get( YandexDeliveryApiClient::class ), $this->container->get( YandexDeliveryGeoMappingRepository::class ), $this->container->get( YandexDeliveryGeoCoverageRepository::class ) ) );
		...
		$this->container->register( YandexDeliveryGeoRegionKeywordFilter::class, fn(): YandexDeliveryGeoRegionKeywordFilter => new YandexDeliveryGeoRegionKeywordFilter() );
		$this->container->register( YandexDeliveryGeoMappingService::class, fn(): YandexDeliveryGeoMappingService => new YandexDeliveryGeoMappingService( $this->container->get( LocationRepository::class ), $this->container->get( YandexDeliveryApiClient::class ), $this->container->get( YandexDeliveryGeoMappingRepository::class ), $this->container->get( YandexDeliveryGeoMatchScorer::class ), $this->container->get( YandexDeliveryGeoResolutionPolicy::class ), 'ambiguous_only', $this->container->get( YandexDeliveryGeoRegionKeywordFilter::class ) ) );
		...
		$this->container->register( CarrierShipmentAdapterRegistry::class, fn(): CarrierShipmentAdapterRegistry => new CarrierShipmentAdapterRegistry( array( $this->container->get( RussianPostShipmentAdapter::class ), $this->container->get( CdekShipmentAdapter::class ), $this->container->get( DpdShipmentAdapter::class ) ) ) );
		$this->container->register( ShipmentCreationService::class, fn(): ShipmentCreationService => new ShipmentCreationService( $this->container->get( OrderShipmentRepository::class ), array( $this->container->get( RussianPostShipmentAdapter::class ), $this->container->get( CdekShipmentAdapter::class ), $this->container->get( DpdShipmentAdapter::class ) ), $this->container->get( Logger::class ), $this->container->get( RussianPostShipmentActualCostLookupService::class ), $this->container->get( CarrierShipmentAdapterRegistry::class ) ) );
		...
		$this->container->register( PickupPointsRestController::class, fn(): PickupPointsRestController => new PickupPointsRestController( $this->container->get( RussianPostPickupPointRepository::class ), $this->container->get( RussianPostPickupPointTypeSettings::class ), $this->container->get( PickupAddressSearchService::class ), $this->container->get( CdekDeliveryPointService::class ), $this->container->get( DpdPickupPointService::class ) ) );
		...
		$this->container->register( CheckoutValidation::class, fn(): CheckoutValidation => new CheckoutValidation( $this->container->get( CheckoutSessionManager::class ), $this->container->get( CheckoutAddressValidation::class ), $this->container->get( RussianPostPickupPointRepository::class ), $this->container->get( DpdPickupPointService::class ) ) );
		...
		$this->container->register( OrderShipmentsMetabox::class, fn(): OrderShipmentsMetabox => new OrderShipmentsMetabox( $this->container->get( OrderShipmentRepository::class ), $this->container->get( OrderShipmentDraftFactory::class ), $this->container->get( ShipmentCreationService::class ), $this->container->get( DeliveryServiceRepository::class ), $this->container->get( ShipmentStatusUpdateService::class ), $this->container->get( CdekOrderStatusService::class ), $this->container->get( ShipmentBacklogService::class ), $this->container->get( RussianPostAddressNormalizer::class ), $this->container->get( RussianPostPickupPointTypeSettings::class ), $this->container->get( CdekDeliveryPointService::class ), $this->container->get( DpdPickupPointService::class ), $this->container->get( \WallsShop\WDC\Shipments\Cdek\CdekRecipientAddressPreparationService::class ), $this->environment->plugin_url(), $this->environment->version(), $this->container->get( CdekBarcodePrintService::class ), $this->container->get( CarrierShipmentAdapterRegistry::class ), $this->container->get( DpdShipmentDocumentService::class ) ) );
