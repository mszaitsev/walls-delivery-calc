...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( OzonDeliveryCourierLocationResolver::class, fn(): OzonDeliveryCourierLocationResolver => new OzonDeliveryCourierLocationResolver( $this->container->get( LocationRepository::class ) ) );
