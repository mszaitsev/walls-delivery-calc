...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( PekShipmentRecipientBuilder::class, fn(): PekShipmentRecipientBuilder => new PekShipmentRecipientBuilder( $this->container->get( PekShipmentCourierAddressResolver::class ) ) );
