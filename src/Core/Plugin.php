...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( YandexShipmentAdapter::class, fn(): YandexShipmentAdapter => new YandexShipmentAdapter( $this->container->get( YandexShipmentRegistrationService::class ), $this->container->get( YandexShipmentButtonPolicy::class ), $this->container->get( YandexStatusMapping::class ), $this->container->get( YandexShipmentLabelPolicy::class ), $this->container->get( ShipmentActualCostComparisonService::class ), $this->container->get( ShipmentBaseApiCostResolver::class ), $this->container->get( ShipmentActualCostResolver::class ) ) );
		...
		$this->container->register( CdekOrderStatusService::class, fn(): CdekOrderStatusService => new CdekOrderStatusService( $this->container->get( OrderShipmentRepository::class ), $this->container->get( CdekApiClient::class ), $this->container->get( Logger::class ), $this->container->get( CdekStatusMappingService::class ), $this->container->get( ShipmentActualCostComparisonService::class ), $this->container->get( ShipmentBaseApiCostResolver::class ), $this->container->get( ShipmentActualCostResolver::class ) ) );
