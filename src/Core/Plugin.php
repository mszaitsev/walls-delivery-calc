...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( YandexShipmentDocumentService::class, fn(): YandexShipmentDocumentService => new YandexShipmentDocumentService( $this->container->get( YandexShipmentRepository::class ), $this->container->get( YandexDeliveryShipmentClient::class ) ) );
