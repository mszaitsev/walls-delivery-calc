...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( OzonDeliveryPickupProgressiveQueryService::class, fn(): OzonDeliveryPickupProgressiveQueryService => new OzonDeliveryPickupProgressiveQueryService( $this->container->get( OzonDeliveryPickupRepository::class ), $this->container->get( OzonDeliveryPickupPointProvider::class ) ) );
		...
		$this->container->register( OzonDeliveryCarrier::class, fn(): OzonDeliveryCarrier => new OzonDeliveryCarrier( $this->container->get( OzonDeliverySettings::class ), $this->container->get( OzonDeliveryCredentials::class ), $this->container->get( OzonDeliveryQuoteService::class ), $this->container->get( Logger::class ), $this->container->get( OzonDeliveryCourierAddressMapper::class ), $this->container->get( OzonDeliveryCourierLocationResolver::class ) ) );
		...
		$this->container->register( OzonDeliveryCourierAddressNormalizer::class, fn(): OzonDeliveryCourierAddressNormalizer => new OzonDeliveryCourierAddressNormalizer( $this->container->get( AddressSuggestionService::class ) ) );
		$this->container->register( OzonDeliveryShipmentCreateRequestBuilder::class, fn(): OzonDeliveryShipmentCreateRequestBuilder => new OzonDeliveryShipmentCreateRequestBuilder( $this->container->get( OzonDeliverySettings::class ), $this->container->get( RussianPhoneNormalizer::class ), $this->container->get( OzonDeliveryShipmentDescriptionBuilder::class ), $this->container->get( OzonDeliveryShipmentAllocationValueResolver::class ), $this->container->get( OzonDeliveryShipmentExternalIdResolver::class ) ) );
		$this->container->register( OzonDeliveryShipmentCreateResponseParser::class, fn(): OzonDeliveryShipmentCreateResponseParser => new OzonDeliveryShipmentCreateResponseParser() );
		$this->container->register( OzonDeliveryShipmentPreflightQuoteService::class, fn(): OzonDeliveryShipmentPreflightQuoteService => new OzonDeliveryShipmentPreflightQuoteService( $this->container->get( OzonDeliveryApiClient::class ), $this->container->get( OzonDeliveryQuoteParser::class ) ) );
		$this->container->register( OzonDeliveryShipmentStatusMapper::class, fn(): OzonDeliveryShipmentStatusMapper => new OzonDeliveryShipmentStatusMapper( $this->container->get( OzonDeliverySettings::class ) ) );
		$this->container->register( OzonDeliveryShipmentInfoParser::class, fn(): OzonDeliveryShipmentInfoParser => new OzonDeliveryShipmentInfoParser() );
		$this->container->register( OzonDeliveryReturnSearchParser::class, fn(): OzonDeliveryReturnSearchParser => new OzonDeliveryReturnSearchParser() );
		$this->container->register( OzonDeliveryReturnInfoParser::class, fn(): OzonDeliveryReturnInfoParser => new OzonDeliveryReturnInfoParser() );
		$this->container->register( OzonDeliveryReturnLifecycleResolver::class, fn(): OzonDeliveryReturnLifecycleResolver => new OzonDeliveryReturnLifecycleResolver() );
		$this->container->register( OzonDeliveryReturnService::class, fn(): OzonDeliveryReturnService => new OzonDeliveryReturnService( $this->container->get( OzonDeliveryApiClient::class ), $this->container->get( OzonDeliveryShipmentExternalIdResolver::class ), $this->container->get( OzonDeliveryReturnSearchParser::class ), $this->container->get( OzonDeliveryReturnInfoParser::class ), $this->container->get( OzonDeliveryReturnLifecycleResolver::class ), $this->container->get( OzonDeliveryShipmentStatusMapper::class ) ) );
		$this->container->register( OzonDeliveryShipmentService::class, fn(): OzonDeliveryShipmentService => new OzonDeliveryShipmentService( $this->container->get( OzonDeliveryApiClient::class ), $this->container->get( OzonDeliveryShipmentCreateRequestBuilder::class ), $this->container->get( OzonDeliveryShipmentCreateResponseParser::class ), $this->container->get( OzonDeliveryShipmentPreflightQuoteService::class ), $this->container->get( OzonDeliveryPickupPointProvider::class ), $this->container->get( OrderShipmentRepository::class ), $this->container->get( ShipmentCreationAttemptService::class ), $this->container->get( OzonDeliveryShipmentStatusMapper::class ), $this->container->get( OzonDeliveryShipmentInfoParser::class ), $this->container->get( OzonDeliveryReturnService::class ), $this->container->get( Logger::class ) ) );
		$this->container->register( OzonDeliveryShipmentAdapter::class, fn(): OzonDeliveryShipmentAdapter => new OzonDeliveryShipmentAdapter( $this->container->get( OzonDeliveryShipmentService::class ), $this->container->get( OzonDeliveryShipmentCreateRequestBuilder::class ), $this->container->get( OrderShipmentRepository::class ), $this->container->get( ShipmentActualCostResolver::class ) ) );
		$this->container->register( OzonDeliveryShipmentPersistenceMapper::class, fn(): OzonDeliveryShipmentPersistenceMapper => new OzonDeliveryShipmentPersistenceMapper() );
		$this->container->register( OzonDeliveryShipmentDocumentProvider::class, fn(): OzonDeliveryShipmentDocumentProvider => new OzonDeliveryShipmentDocumentProvider( $this->container->get( OzonDeliveryApiClient::class ) ) );
		$this->container->register( OzonDeliveryShipmentModalExtension::class, fn(): OzonDeliveryShipmentModalExtension => new OzonDeliveryShipmentModalExtension( $this->container->get( OzonDeliveryPickupRepository::class ) ) );
		...
		$this->container->register( ShipmentDocumentProviderRegistry::class, fn(): ShipmentDocumentProviderRegistry => new ShipmentDocumentProviderRegistry( array( $this->container->get( CdekShipmentDocumentProvider::class ), $this->container->get( DpdShipmentDocumentProvider::class ), $this->container->get( YandexShipmentDocumentProvider::class ), $this->container->get( RussianPostShipmentDocumentProvider::class ), $this->container->get( PekShipmentDocumentProvider::class ), $this->container->get( OzonDeliveryShipmentDocumentProvider::class ) ) ) );
		...
		$this->container->register( CdekCarrier::class, fn(): CdekCarrier => new CdekCarrier( $this->container->get( CdekSettings::class ), $this->container->get( CdekApiClient::class ), $this->container->get( CdekLocationResolver::class ), $this->container->get( Logger::class ), $this->container->get( CdekDeliveryPointService::class ), $this->container->get( CdekTariffRepository::class ), $this->container->get( CheckoutLocationFingerprint::class ) ) );
		...
		$this->container->register( DeliveryCustomerCommentNormalizer::class, fn(): DeliveryCustomerCommentNormalizer => new DeliveryCustomerCommentNormalizer() );
		$this->container->register( DeliveryCustomerCommentSnapshotBuilder::class, fn(): DeliveryCustomerCommentSnapshotBuilder => new DeliveryCustomerCommentSnapshotBuilder( $this->container->get( DeliveryCustomerCommentNormalizer::class ) ) );
		$this->container->register( DeliveryCustomerCommentRenderer::class, fn(): DeliveryCustomerCommentRenderer => new DeliveryCustomerCommentRenderer( $this->container->get( DeliveryCustomerCommentNormalizer::class ) ) );
		...
		$this->container->register( AddressSuggestionAjax::class, fn(): AddressSuggestionAjax => new AddressSuggestionAjax( $this->container->get( AddressSuggestionService::class ), $this->container->get( DaDataTokenPool::class ), $this->container->get( CheckoutSessionManager::class ), $this->container->get( LocationRepository::class ) ) );
		...
		$this->container->register( GarPlacesCsvImporter::class, fn(): GarPlacesCsvImporter => new GarPlacesCsvImporter( $this->container->get( LocationRepository::class ), $this->container->get( RegionRepository::class ) ) );
		...
		$this->container->register( OrderDeliveryDataClearService::class, fn(): OrderDeliveryDataClearService => new OrderDeliveryDataClearService( $this->container->get( OrderShipmentRepository::class ) ) );
		$this->container->register( OrderEditabilityPolicy::class, fn(): OrderEditabilityPolicy => new OrderEditabilityPolicy( $this->container->get( SettingsRepository::class ) ) );
		...
		$this->container->register( OrderDeliveryReplacementService::class, fn(): OrderDeliveryReplacementService => new OrderDeliveryReplacementService( $this->container->get( OrderShipmentRepository::class ), $this->container->get( DeliveryDateFormatter::class ), $this->container->get( DeliveryCalculationDataBuilder::class ), $this->container->get( CarrierPickupPointProviderRegistry::class ), $this->container->get( PekCheckoutQuoteContextResolver::class ), $this->container->get( PekCheckoutPickupPointFormatter::class ), $this->container->get( DeliveryCustomerCommentNormalizer::class ) ) );
		$this->container->register( OrderDeliveryRateRenderer::class, fn(): OrderDeliveryRateRenderer => new OrderDeliveryRateRenderer() );
		$this->container->register( OrderDeliveryRecalculationAdminController::class, fn(): OrderDeliveryRecalculationAdminController => new OrderDeliveryRecalculationAdminController( $this->container->get( OrderDeliveryRecalculationService::class ), $this->container->get( OrderDeliveryRateRenderer::class ), $this->container->get( CheckoutLocationAjax::class ), $this->container->get( RussianPostPickupPointRepository::class ), $this->container->get( OrderDeliveryAddressNormalizationService::class ), $this->container->get( OrderDeliveryReplacementService::class ), $this->container->get( YandexDeliveryCheckoutPickupPointFormatter::class ), $this->container->get( SettingsRepository::class ), $this->container->get( RussianPostPickupPointTypeSettings::class ), $this->container->get( DpdPickupPointScheduleFormatter::class ), $this->container->get( CarrierPickupPointProviderRegistry::class ), $this->container->get( PekCheckoutQuoteContextResolver::class ), $this->container->get( PekCheckoutPickupPointFormatter::class ), $this->container->get( PekCountryPolicy::class ), $this->environment->plugin_url(), $this->environment->version(), $this->container->get( CdekDeliveryPointService::class ), $this->container->get( DpdPickupPointService::class ), $this->container->get( YandexDeliveryPickupPointV2Repository::class ), $this->container->get( YandexLocationMappingV2Repository::class ), $this->container->get( OrderDeliveryDataClearService::class ), $this->container->get( OzonDeliveryPickupProgressiveQueryService::class ) ) );
		$this->container->register( OrderDeliveryMetabox::class, fn(): OrderDeliveryMetabox => new OrderDeliveryMetabox( $this->container->get( OrderShipmentRepository::class ), $this->container->get( DeliveryCustomerCommentRenderer::class ), $this->container->get( DeliveryCustomerCommentNormalizer::class ) ) );
