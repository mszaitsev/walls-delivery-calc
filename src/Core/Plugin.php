...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( PekShipmentDestinationResolver::class, fn(): PekShipmentDestinationResolver => new PekShipmentDestinationResolver( $this->container->get( PekPickupPointProvider::class ) ) );
		...
		$this->container->register( PekShipmentAdapter::class, fn(): PekShipmentAdapter => new PekShipmentAdapter( $this->container->get( PekApiClient::class ), $this->container->get( PekShipmentRequestBuilder::class ), $this->container->get( PekShipmentStatusService::class ), $this->container->get( PekShipmentService::class ), $this->container->get( PekShipmentButtonPolicy::class ), $this->container->get( ShipmentActualCostResolver::class ), $this->container->get( Logger::class ) ) );
