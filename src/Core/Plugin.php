...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( CdekShipmentAdapter::class, fn(): CdekShipmentAdapter => new CdekShipmentAdapter( $this->container->get( CdekApiClient::class ), $this->container->get( CdekCreateRequestBuilder::class ), $this->container->get( Logger::class ) ) );
		$this->container->register( CdekOrderStatusService::class, fn(): CdekOrderStatusService => new CdekOrderStatusService( $this->container->get( OrderShipmentRepository::class ), $this->container->get( CdekApiClient::class ), $this->container->get( Logger::class ) ) );
		...
		$this->container->register( ShipmentCreationService::class, fn(): ShipmentCreationService => new ShipmentCreationService( $this->container->get( OrderShipmentRepository::class ), array( $this->container->get( RussianPostShipmentAdapter::class ), $this->container->get( CdekShipmentAdapter::class ) ), $this->container->get( Logger::class ), $this->container->get( RussianPostShipmentActualCostLookupService::class ) ) );
		...
		$this->container->register( \WallsShop\WDC\Shipments\Cdek\CdekRecipientAddressPreparationService::class, fn(): \WallsShop\WDC\Shipments\Cdek\CdekRecipientAddressPreparationService => new \WallsShop\WDC\Shipments\Cdek\CdekRecipientAddressPreparationService( $this->container->get( OrderDeliveryAddressNormalizationService::class ), $this->container->get( CdekApiClient::class ) ) );
		$this->container->register( OrderShipmentsMetabox::class, fn(): OrderShipmentsMetabox => new OrderShipmentsMetabox( $this->container->get( OrderShipmentRepository::class ), $this->container->get( OrderShipmentDraftFactory::class ), $this->container->get( ShipmentCreationService::class ), $this->container->get( DeliveryServiceRepository::class ), $this->container->get( ShipmentStatusUpdateService::class ), $this->container->get( CdekOrderStatusService::class ), $this->container->get( ShipmentBacklogService::class ), $this->container->get( RussianPostAddressNormalizer::class ), $this->container->get( RussianPostPickupPointTypeSettings::class ), $this->container->get( CdekDeliveryPointService::class ), $this->container->get( \WallsShop\WDC\Shipments\Cdek\CdekRecipientAddressPreparationService::class ), $this->environment->plugin_url(), $this->environment->version() ) );
