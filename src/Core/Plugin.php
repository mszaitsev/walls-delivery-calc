...
final class Plugin {
	...
	private function register_services(): void {
		...
		$this->container->register( PekShipmentService::class, fn(): PekShipmentService => new PekShipmentService( $this->container->get( PekApiClient::class ), $this->container->get( PekShipmentStatusService::class ), $this->container->get( OrderShipmentRepository::class ), $this->container->get( PekShipmentButtonPolicy::class ), $this->container->get( ShipmentActualCostService::class ) ) );
