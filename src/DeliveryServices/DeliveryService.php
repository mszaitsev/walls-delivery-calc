...
final class DeliveryService {
	...
	public function __construct(
		...
		public readonly string $pickup_customer_comment = '',
		public readonly string $courier_customer_comment = '',
	...
	public static function from_array( array $row ): self {
		return new self(
			...
			(string) ( $row['pickup_customer_comment'] ?? '' ),
			(string) ( $row['courier_customer_comment'] ?? '' ),
	...
	public function to_array(): array {
		return array(
			...
			'pickup_customer_comment' => $this->pickup_customer_comment,
			'courier_customer_comment' => $this->courier_customer_comment,
