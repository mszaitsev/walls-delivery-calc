...
final class SettingsRepository {
	...
	public function defaults(): array {
		return array_merge(
			...
			CheckoutDeliveryMessageSettings::PROMO_THRESHOLD_KOPECKS_KEY => CheckoutDeliveryMessageSettings::DEFAULT_PROMO_THRESHOLD_KOPECKS,
			CheckoutDeliveryMessageSettings::PROMO_TOTAL_BASIS_KEY => CheckoutDeliveryMessageSettings::BASIS_ALL_CART_ITEMS,
			CheckoutDeliveryMessageSettings::PROMO_BELOW_HTML_KEY => CheckoutDeliveryMessageSettings::DEFAULT_PROMO_BELOW_HTML,
			CheckoutDeliveryMessageSettings::PROMO_REACHED_HTML_KEY => CheckoutDeliveryMessageSettings::DEFAULT_PROMO_REACHED_HTML,
			...
			'russian_post_domestic_point_type_ops_enabled' => true,
			'russian_post_domestic_point_type_ops_label' => 'Отделение Почты России',
			'russian_post_domestic_point_type_pvz_enabled' => true,
			'russian_post_domestic_point_type_pvz_label' => 'Пункт выдачи',
