...
final class DeliveryStatus {
	public const PENDING_CREATION_IN_CARRIER = 'pending_creation_in_carrier';
	...
	public static function all(): array {
		return array( self::PENDING_CREATION_IN_CARRIER, self::CREATED_IN_CARRIER, self::IN_TRANSIT, self::READY_FOR_PICKUP, self::HANDED_TO_COURIER, self::DELIVERED, self::RETURNING_TO_SENDER, self::RETURNED_TO_SENDER, self::CANCELLED, self::REJECTED, self::UNKNOWN );
	}
	...
	public static function labels(): array {
		return array(
			self::PENDING_CREATION_IN_CARRIER => 'Попытка создания в ТК',
