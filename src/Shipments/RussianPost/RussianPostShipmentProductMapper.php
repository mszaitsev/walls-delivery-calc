...
final class RussianPostShipmentProductMapper {
	...
	public function by_object_code( string|int $object_code, string $delivery_type = '' ): array {
		...
		$map = array(
			'4030' => array( 'POSTAL_PARCEL', 'SIMPLE', 'POSTAL_PARCEL', false ),
			'4020' => array( 'POSTAL_PARCEL', 'WITH_DECLARED_VALUE', 'POSTAL_PARCEL', false ),
			'47030' => array( 'PARCEL_CLASS_1', 'SIMPLE', 'PARCEL_CLASS_1', false ),
			...
			'23030' => array( 'ONLINE_PARCEL', 'SIMPLE', 'ONLINE_PARCEL', true ),
			'23020' => array( 'ONLINE_PARCEL', 'WITH_DECLARED_VALUE', 'ONLINE_PARCEL', true ),
			'24030' => array( 'ONLINE_COURIER', 'SIMPLE', 'ONLINE_COURIER', true ),
			'24020' => array( 'ONLINE_COURIER', 'WITH_DECLARED_VALUE', 'ONLINE_COURIER', true ),
			'7030' => array( 'EMS', 'SIMPLE', 'EMS', false ),
			'7020' => array( 'EMS', 'WITH_DECLARED_VALUE', 'EMS', false ),
			'41030' => array( 'EMS_RT', 'SIMPLE', 'EMS_RT', true ),
			'52030' => array( 'EMS_TENDER', 'SIMPLE', 'EMS_TENDER', true ),
		);
		$row = $map[ $code ] ?? ( 'courier' === $delivery_type ? array( 'ONLINE_COURIER', 'SIMPLE', 'ONLINE_COURIER', true ) : array( 'ONLINE_PARCEL', 'SIMPLE', 'ONLINE_PARCEL', true ) );
