...
final class OrderShipmentsMetabox {
	...
	public function enqueue_assets(): void {
		...
		wp_enqueue_script( 'wdc-shipments-admin-ozon-delivery', $this->plugin_url . 'assets/admin/shipments/extensions/ozon-delivery.js', array( 'wdc-shipments-admin-pek' ), $this->version, true );
		wp_enqueue_script( 'wdc-shipments-admin-events', $this->plugin_url . 'assets/admin/shipments/shipment-events.js', array( 'wdc-shipments-admin-ozon-delivery' ), $this->version, true );
		...
		<div class="wdc-shipments-metabox" data-wdc-shipments-metabox data-carrier-key="<?php echo esc_attr( $carrier_key ); ?>" data-has-shipment="<?php echo $has_created ? '1' : '0'; ?>" <?php $this->render_presentation_attrs( $presentation ); ?>>
			...
			<div class="wdc-shipment-modal" data-wdc-shipment-modal hidden>
				<div class="wdc-shipment-modal__dialog" role="dialog" aria-modal="true" aria-label="<?php echo esc_attr( $modal_title ); ?>">
					...
					<h2 class="wdc-shipment-modal__title"><?php echo esc_html( $modal_title ); ?></h2>
