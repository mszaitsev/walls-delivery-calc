	...
	private function render_inner( mixed $post_or_order ): void {
		...
		<div class="wdc-shipments-metabox" data-wdc-shipments-metabox data-carrier-key="<?php echo esc_attr( $carrier_key ); ?>" data-has-shipment="<?php echo $has_created ? '1' : '0'; ?>" <?php $this->render_presentation_attrs( $presentation ); ?>>
			...
			<p class="wdc-shipments-actions">
				...
				<a class="button" data-wdc-cdek-barcode-download href="<?php echo esc_url( $cdek_barcode_download_url ); ?>" <?php echo $show_cdek_barcode ? '' : 'hidden'; ?>><?php echo esc_html__( 'Скачать этикетку', 'walls-delivery-calc' ); ?></a>
				<a class="button" data-wdc-cdek-barcode-inline href="<?php echo esc_url( $cdek_barcode_inline_url ); ?>" target="_blank" rel="noopener" <?php echo $show_cdek_barcode ? '' : 'hidden'; ?>><?php echo esc_html__( 'Открыть этикетку', 'walls-delivery-calc' ); ?></a>
