		...
		return array(
			...
			'services' => array(
				self::SERVICE_RUSSIAN_POST_WORLDWIDE_PARCEL => array(
					...
					'formula_add_rub' => 200,
					'shipping_discount_percent_from_items_total' => 0,
		...
		return array(
			...
			'services' => array(
				self::SERVICE_RUSSIAN_POST_WORLDWIDE_PARCEL => array(
					...
					'shipping_discount_percent_from_items_total' => min( 100, max( 0, (float) $service['shipping_discount_percent_from_items_total'] ) ),
