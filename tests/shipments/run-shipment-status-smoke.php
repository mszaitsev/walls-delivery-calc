...
shipment_status_smoke_assert( str_contains( $status_service_source, 'TimezoneService::TIMEZONE' ) && ! str_contains( $status_service_source, '7 * $hour' ), 'tracking_checked_at helper must use the canonical WDC timezone without a manual GMT+7 offset.' );
