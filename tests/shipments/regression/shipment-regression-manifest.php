...
return array(
	...
	'framework.action-scheduler-lifecycle' => array( 'path' => 'tests/infrastructure/run-action-scheduler-lifecycle-smoke.php', 'groups' => array( 'framework' ) ),
	...
	'self-pickup.foundation' => array( 'path' => 'tests/self-pickup/run-self-pickup-smoke.php', 'groups' => array( 'self-pickup' ) ),
	...
	'ozon-delivery.pickup-two-phase' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-pickup-two-phase-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	'ozon-delivery.pickup-cancellation-race' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-pickup-cancellation-race-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	'ozon-delivery.pickup-ready-transition-race' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-pickup-ready-transition-race-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	'ozon-delivery.pickup-owner' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-pickup-owner-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	...
	'ozon-delivery.pickup-query-count' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-pickup-query-count-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	...
	'ozon-delivery.pickup-progressive-map' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-pickup-progressive-map-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	'ozon-delivery.pickup-worker' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-pickup-worker-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	'ozon-delivery.returns' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-return-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	'ozon-delivery.modal-limits' => array( 'path' => 'tests/ozon-delivery/run-ozon-delivery-modal-limits-smoke.php', 'groups' => array( 'ozon-delivery' ) ),
	...
	'pek.international-runtime' => array( 'path' => 'tests/pek/run-pek-international-runtime-smoke.php', 'groups' => array( 'pek' ) ),
