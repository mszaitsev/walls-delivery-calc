...
russian_post_cancel_smoke_assert( str_contains( $metabox_source, '$show_primary_actions = ! $has_created' ) && str_contains( $metabox_source, '$show_update = $has_created &&' ), 'Metabox must compute primary and update button visibility.' );
russian_post_cancel_smoke_assert( str_contains( $metabox_source, 'data-wdc-open-shipment-modal <?php echo $show_primary_actions' ) && str_contains( $metabox_source, 'data-wdc-open-manual-tracking <?php echo $show_primary_actions' ), 'Initial state must show prepare/manual actions and hide inactive actions.' );
...
russian_post_cancel_smoke_assert( str_contains( $js_source, 'openButton.hidden = hasTracking' ) && str_contains( $js_source, 'updateButton.hidden = !hasTracking' ) && str_contains( $js_source, 'manualButton.hidden = hasTracking' ), 'JS must hide inactive primary/update/manual buttons.' );
