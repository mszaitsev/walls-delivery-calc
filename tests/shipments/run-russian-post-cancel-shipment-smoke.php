...
russian_post_cancel_smoke_assert( str_contains( $metabox_source, '$show_primary_actions' ) && str_contains( $metabox_source, '! $has_created' ) && str_contains( $metabox_source, '$show_update = $has_created && $can_update' ), 'Metabox must compute primary and update button visibility.' );
...
russian_post_cancel_smoke_assert( str_contains( $js_source, 'setVisible(openButton, !hasShipment)' ) && str_contains( $js_source, 'setVisible(updateButton, canUpdate)' ) && str_contains( $js_source, 'setVisible(manualButton, !hasShipment)' ), 'JS must hide inactive primary/update/manual buttons.' );
