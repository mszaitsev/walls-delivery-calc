...
shipment_admin_ajax_assert( 'manage_woocommerce' === WallsShop\WDC\Shipments\Admin\Ajax\ShipmentAdminAjaxService::CAPABILITY, 'Order shipment operational AJAX must remain available under manage_woocommerce.' );
