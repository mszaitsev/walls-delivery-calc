...
shipment_admin_js_structure_assert( str_contains( $source['ozon'], 'data-wdc-ozon-place-limits' ) && str_contains( $source['ozon'], 'createAvailability' ) && str_contains( $source['ozon'], 'dimensionsFit' ) && str_contains( $source['ozon'], 'hasConfirmedOzonCourierAddress' ) && str_contains( $source['ozon'], 'validateOzonCourierAddress' ), 'Ozon Delivery extension must own Ozon pickup point limit validation and courier address create availability hook.' );
