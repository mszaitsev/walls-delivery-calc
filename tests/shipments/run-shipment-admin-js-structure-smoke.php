...
shipment_admin_js_structure_assert( str_contains( $source['polling'], 'function continueShipmentLifecycle' ) && str_contains( $source['polling'], 'function handleShipmentLifecycleResult' ) && str_contains( $source['polling'], 'submitRequired' ) && str_contains( $source['polling'], 'pollRequired' ), 'Polling module must own the carrier-neutral lifecycle continuation client.' );
shipment_admin_js_structure_assert( ! str_contains( $source['polling'], 'submitDpdRegistration' ) && ! str_contains( $source['polling'], 'startDpdRegistrationPolling' ) && ! str_contains( $source['polling'], 'registration_attempt_id' ) && ! str_contains( $source['polling'], 'mode=dpd' ), 'Polling module must not own DPD lifecycle wrappers or DPD-specific markers.' );
