...
carrier_adapter_registry_assert( str_contains( $plugin_source, 'new ShipmentCreationService( $this->container->get( OrderShipmentRepository::class ), array( $this->container->get( RussianPostShipmentAdapter::class ), $this->container->get( CdekShipmentAdapter::class ), $this->container->get( DpdShipmentAdapter::class ), $this->container->get( YandexShipmentAdapter::class ) )' ) && str_contains( $plugin_source, 'RussianPostShipmentPersistenceMapper::class' ) && str_contains( $plugin_source, 'CdekShipmentPersistenceMapper::class' ) && str_contains( $plugin_source, 'DpdShipmentPersistenceMapper::class' ) && str_contains( $plugin_source, 'YandexShipmentPersistenceMapper::class' ), 'ShipmentCreationService live-create adapter list must include all carriers and persistence mappers.' );
