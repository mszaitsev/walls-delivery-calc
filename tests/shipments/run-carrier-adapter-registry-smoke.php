...
carrier_adapter_registry_assert( str_contains( $plugin_source, 'new CarrierShipmentAdapterRegistry( array(' ) && str_contains( $plugin_source, 'RussianPostShipmentAdapter::class' ) && str_contains( $plugin_source, 'CdekShipmentAdapter::class' ) && str_contains( $plugin_source, 'DpdShipmentAdapter::class' ) && str_contains( $plugin_source, 'YandexShipmentAdapter::class' ) && str_contains( $plugin_source, 'JetLogisticShipmentAdapter::class' ) && str_contains( $plugin_source, 'PekShipmentAdapter::class' ) && str_contains( $plugin_source, 'OzonDeliveryShipmentAdapter::class' ), 'Plugin registry wiring must include Russian Post, CDEK, DPD, Yandex, Jet, PEK and Ozon adapters.' );
carrier_adapter_registry_assert( str_contains( $plugin_source, 'new ShipmentCreationService( $this->container->get( OrderShipmentRepository::class )' ) && str_contains( $plugin_source, 'RussianPostShipmentPersistenceMapper::class' ) && str_contains( $plugin_source, 'CdekShipmentPersistenceMapper::class' ) && str_contains( $plugin_source, 'DpdShipmentPersistenceMapper::class' ) && str_contains( $plugin_source, 'YandexShipmentPersistenceMapper::class' ) && str_contains( $plugin_source, 'PekShipmentPersistenceMapper::class' ) && str_contains( $plugin_source, 'OzonDeliveryShipmentPersistenceMapper::class' ) && ! str_contains( $plugin_source, 'new ShipmentCreationService( $this->container->get( OrderShipmentRepository::class ), array( $this->container->get( RussianPostShipmentAdapter::class ), $this->container->get( CdekShipmentAdapter::class ), $this->container->get( DpdShipmentAdapter::class ), $this->container->get( YandexShipmentAdapter::class ) ), $this->container->get( Logger::class ), $this->container->get( CarrierShipmentAdapterRegistry::class ), null' ), 'ShipmentCreationService live-create wiring must include all create adapters, all persistence mappers and no mapper placeholder.' );
...
carrier_adapter_registry_assert( str_contains( $payload_builder_source, "'has_shipment' => ! empty( \$status['has_shipment'] )" ) && str_contains( $payload_builder_source, "'can_update_status' => ! \$non_shipment_active && ! empty( \$status['can_update_status'] )" ) && str_contains( $payload_builder_source, "'can_cancel' => ! \$non_shipment_active && ! empty( \$status['can_cancel'] )" ) && str_contains( $payload_builder_source, "'can_remove_from_order' => ! \$non_shipment_active && ! empty( \$status['can_remove_from_order'] )" ), 'Carrier UI payload must expose normalized button flags for JS.' );
