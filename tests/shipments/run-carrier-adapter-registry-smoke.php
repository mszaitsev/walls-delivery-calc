...
carrier_adapter_registry_assert( str_contains( $shipments_js, 'function shipmentStatusFromResponse' ) && str_contains( $shipments_js, "['carrier_key', 'presentation', 'label_actions', 'has_shipment', 'can_update_status', 'can_cancel', 'can_remove_from_order']" ), 'Shipment JS must normalize adapter UI payload flags without rebuilding carrier-specific state.' );
