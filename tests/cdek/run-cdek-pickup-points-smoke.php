...
cdek_pickup_assert( str_contains( $validation_source, '$is_russian_post_family' ) && str_contains( $validation_source, 'lookup_allowed' ) && str_contains( $validation_source, 'RussianPostDomesticSettings::CARRIER_KEY . \':pickup\'' ), 'Checkout validation must allow Russian Post repository lookup only for Russian Post pickup family.' );
