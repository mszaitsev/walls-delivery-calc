...
cdek_order_assert( str_contains( $weight_hint_modal_html, 'data-wdc-weight-hint' ) && str_contains( $weight_hint_modal_html, 'Расчётный вес товаров: 2250 г' ), 'Shipment modal one-place weight label must render calculated weight as an explicit hint.' );
