...
runtime_smoke_assert( runtime_smoke_has_filter_callback( 'woocommerce_checkout_fields', \WallsShop\WDC\Checkout\WooCommerce\CheckoutFieldConfigurator::class ), 'Checkout field configurator must register in the full checkout runtime.' );
...
runtime_smoke_assert( ! runtime_smoke_has_filter_callback( 'woocommerce_checkout_fields', \WallsShop\WDC\Checkout\WooCommerce\CheckoutFieldConfigurator::class ), 'Checkout field configurator must not register when platform runtime is disabled.' );
