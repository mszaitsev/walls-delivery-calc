...
pek_assert( str_contains( $shipment_manifest, "'pek.foundation'" ) && str_contains( $shipment_manifest, "'pek.admin-routing'" ) && str_contains( $shipment_manifest, "'pek.admin-ui'" ) && str_contains( $shipment_manifest, "'pek.warehouse-datetime'" ) && str_contains( $shipment_manifest, "'pek.quote-foundation'" ) && str_contains( $shipment_manifest, "'pek.checkout-runtime'" ) && str_contains( $shipment_manifest, "'pek.shipment-create'" ) && str_contains( $shipment_manifest, "'pek.shipment-modal'" ), 'PEK mandatory smokes must be in shipment regression manifest.' );
