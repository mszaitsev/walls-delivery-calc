...
plugin_architecture_assert( str_contains( $pek_quote_cargo_builder_source, 'LIGHT_CARGO_PRODUCT_WEIGHT_THRESHOLD_G = 3000' ) && str_contains( $pek_quote_cargo_builder_source, '$product_weight_g = max( 0, $package->weight_g )' ) && str_contains( $pek_quote_cargo_builder_source, '$product_weight_g < self::LIGHT_CARGO_PRODUCT_WEIGHT_THRESHOLD_G' ) && str_contains( $pek_quote_cargo_builder_source, '$total_weight_g = $package->total_weight_g > 0 ? $package->total_weight_g : $package->get_total_weight_g()' ) && str_contains( $pek_quote_cargo_builder_source, '$requires_protective_transport_packaging = false' ) && str_contains( $pek_quote_cargo_builder_source, "'isHP' => \$requires_protective_transport_packaging" ) && str_contains( $pek_quote_cargo_builder_source, "'sealingPositionsCount' => \$requires_light_cargo_sealing ? 1 : 0" ) && str_contains( $pek_quote_cargo_builder_source, "'light_cargo_sealing_required'" ) && str_contains( $pek_quote_cargo_builder_source, "'protective_transport_packaging_requested'" ) && ! str_contains( $pek_quote_cargo_builder_source, "'isHP' => \$requires_light_cargo_sealing" ) && ! str_contains( $pek_quote_cargo_builder_source, "'isHP' => true" ) && str_contains( $pek_quote_request_builder_source, "'cargo_policy' => \$this->cargo_builder->last_diagnostics()" ) && ! preg_match( '/\b(?:bag|packagingType|packageType)\b/i', $pek_quote_request_builder_source . "\n" . $pek_quote_cargo_builder_source ), 'PEK quote cargo builder must keep isHP independent from the <3000 g light-cargo sealing threshold, explicitly disable protective transport packaging, set one seal below threshold, and expose separated diagnostics without undocumented bag aliases.' );
