...
plugin_architecture_assert( str_contains( $manual_pickup_repository_source, "'point_title' => \$title" ) && str_contains( $manual_pickup_repository_source, "'point_name' => \$title" ) && str_contains( $manual_pickup_repository_source, "'display_code' => ''" ) && str_contains( $manual_pickup_repository_source, "'reload_on_viewport_change' => false" ) && ! str_contains( $manual_pickup_repository_source, "'display_code' => \$row['code']" ) && ! str_contains( $manual_pickup_repository_source, "'presentation_comment' => \$row['comment']" ), 'Manual pickup projection must expose admin title as the customer-facing name, keep stable code internal, avoid duplicating normal comments as presentation comments, and declare a fixed local dataset capability.' );
plugin_architecture_assert( str_contains( $pickup_points_rest_source, '$type_label' ) && str_contains( $pickup_points_rest_source, '$point_title' ) && str_contains( $pickup_points_rest_source, "'point_comment' => \$point_comment" ) && str_contains( $pickup_points_rest_source, "'display_title' => \$display_title" ), 'Generic registry pickup REST must keep type label, point title, display code, and point_comment as separate presentation fields.' );
