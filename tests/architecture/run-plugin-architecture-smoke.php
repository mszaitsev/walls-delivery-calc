...
plugin_architecture_assert( str_contains( $attempt_service_source, 'invalidate_option_cache_after_delete' ) && str_contains( $attempt_service_source, 'wp_cache_delete( $key, \'options\' )' ) && str_contains( $attempt_service_source, "'notoptions'" ), 'Successful direct SQL CAS delete must invalidate WordPress option and notoptions caches.' );
