...
plugin_architecture_assert( str_contains( $ozon_plugin_source, 'OzonDeliveryPickupPointProvider::class' ) && str_contains( $ozon_pickup_provider_source, 'CarrierPickupPointProviderInterface' ) && str_contains( $ozon_pickup_provider_source, 'find_active_in_radius' ) && ! str_contains( $ozon_pickup_provider_source, 'OzonDeliveryApiClient' ), 'Ozon pickup provider must be carrier-owned, registry-wired and local-database-only.' );
plugin_architecture_assert( str_contains( $ozon_quote_service_source, "'pickup_provider_query' => \$this->query_snapshot( \$query, \$request )" ) && str_contains( $ozon_quote_service_source, "'destination_fingerprint' => \$fingerprint" ) && str_contains( $ozon_quote_service_source, "'provider_destination_fingerprint' => \$fingerprint" ) && str_contains( $ozon_quote_service_source, 'function destination_fingerprint' ), 'Ozon quote service must carry the generic destination fingerprint in the trusted pickup provider snapshot.' );
