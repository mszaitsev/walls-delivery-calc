...
plugin_architecture_assert( str_contains( $checkout_session_source, '$parts[0] = $carrier' ) && ! str_contains( $checkout_session_source, '? $carrier . \':pickup\'' ), 'Checkout session pickup-family normalization must preserve multi-segment service-specific pickup families.' );
