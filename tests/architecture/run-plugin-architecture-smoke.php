...
plugin_architecture_assert( str_contains( $plugin_source, 'OzonDeliveryPickupPointProvider::class' ), 'Plugin.php must register the Ozon pickup provider through the canonical registry.' );
