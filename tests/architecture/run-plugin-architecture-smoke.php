...
plugin_architecture_assert( str_contains( $checkout_provider_resolver_source, "\$rate_service_normalized" ) && str_contains( $checkout_provider_resolver_source, "'' === \$rate_service_normalized" ), 'Checkout pickup provider resolver must require a trusted non-empty service key from the stored rate envelope.' );
