...
plugin_architecture_assert( str_contains( $ozon_shipment_values_source, 'ShipmentOrderItemIdentityResolver' ) && str_contains( $shipment_item_identity_source, "':split:'" ) && str_contains( $shipment_modal_mapper_source, "'split_parent'" ), 'Ozon shipment item matching must use the generic Shipment modal item identity contract including split rows.' );
