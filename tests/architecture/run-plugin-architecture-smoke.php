...
plugin_architecture_assert( str_contains( $pek_button_policy_source, 'PENDING_CREATION_IN_CARRIER' ) && str_contains( $pek_button_policy_source, "'manual_attach' => true" ) && str_contains( $pek_button_policy_source, "'remove' => true" ), 'PEK pending creation record must allow manual reconciliation and explicit local remove.' );
