...
plugin_architecture_assert( str_contains( $pek_status_mapping_source, 'is_cancelled_status' ) && str_contains( $pek_status_mapping_source, "'аннулировано до приемки груза' === self::normalize_status" ) && str_contains( $pek_status_mapping_source, 'is_pre_acceptance_status' ), 'PEK cancellation and pre-acceptance carrier facts must remain immutable raw-status predicates.' );
