...
plugin_architecture_assert( str_contains( $pek_request_builder_source, 'courier_location_match' ) && str_contains( $pek_request_builder_source, 'courier_branch_source' ) && str_contains( $pek_request_builder_source, 'courier_address_hash' ), 'PEK safe preview must expose courier destination binding evidence without raw address.' );
