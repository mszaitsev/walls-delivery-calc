...
plugin_architecture_assert( str_contains( $pek_sender_warehouse_source, 'divisionCapabilitiesPresent' ) && str_contains( $pek_sender_warehouse_source, 'effectiveCapabilitySource' ) && str_contains( $pek_sender_warehouse_source, "'division'" ) && str_contains( $pek_sender_warehouse_source, "'warehouse'" ) && ! str_contains( $pek_sender_warehouse_source, '$warehouse_has_capabilities ?' ), 'PEK sender warehouse branches/all validation must prefer division capabilities and keep safe diagnostic source fields.' );
plugin_architecture_assert( str_contains( $generic_picker_source, 'window.wdcShipmentPickupPicker' ) && str_contains( $pek_picker_source, 'window.wdcShipmentPickupPicker' ) && str_contains( $pek_picker_source, 'handleClick: function (event)' ) && str_contains( $pek_picker_source, 'picker.open(form' ) && str_contains( $pek_picker_source, 'data-wdc-pek-sender-warehouse-context' ) && ! str_contains( $generic_picker_source, "carrier === 'pek'" ) && ! str_contains( $pek_picker_source, 'wdc:shipment-pickup-search-open' ) && ! str_contains( $pek_picker_source, 'addEventListener(\'click\'' ), 'PEK sender warehouse picker must consume a working generic picker API through carrier handleClick without a generic PEK branch or duplicate modal listeners.' );
