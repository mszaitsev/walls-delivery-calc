...
rpd_assert( '5-6 дней' === (string) ( $selected_rate->meta['tariff_variants'][0]['delivery_days_label'] ?? '' ) && '5-6 дней' === (string) ( $selected_rate->meta['tariff_variants'][0]['planned_delivery_comment'] ?? '' ), 'Domestic selector range variant row must use final delivery days label instead of stale planned comment.' );
...
rpd_assert( $stale_range_rate instanceof DeliveryRate && '5-6 дней' === (string) ( $stale_range_rate->meta['tariff_variants'][0]['delivery_days_label'] ?? '' ) && '5-6 дней' === (string) ( $stale_range_rate->meta['tariff_variants'][0]['planned_delivery_comment'] ?? '' ), 'Domestic selector stale range variant row must use final delivery days label.' );
...
rpd_assert( $rule_adjusted_rate instanceof DeliveryRate && '7-8 дней' === (string) ( $rule_adjusted_rate->meta['tariff_variants'][0]['delivery_days_label'] ?? '' ) && '7-8 дней' === (string) ( $rule_adjusted_rate->meta['tariff_variants'][0]['planned_delivery_comment'] ?? '' ), 'Domestic selector rule-adjusted variant row must use final adjusted delivery days.' );
