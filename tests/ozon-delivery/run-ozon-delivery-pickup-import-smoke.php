...
oz_pickup_assert( str_contains( $importer, 'run_discovery_step' ) && str_contains( $importer, 'run_enrichment_step' ) && str_contains( $importer, 'pending_ids' ) && str_contains( $importer, 'ready_for_activation' ) && str_contains( $importer, 'pickup_enrichment_incomplete' ), 'importer must own a phase-aware discovery/enrichment workflow with a completion invariant before activation.' );
