...
try {
	( new MigrationManager( '1.0.4-test', $migration_dir ) )->run();
...
( new MigrationManager( '1.0.4-test', $migration_dir ) )->run();
oz_pickup_assert( in_array( '0002_future_schema.php', (array) get_option( 'wdc_applied_migrations', array() ), true ) && '1.0.4-test' === get_option( 'wdc_db_version', '' ), 'MigrationManager must rerun failed future migration and mark it applied only after success.' );
