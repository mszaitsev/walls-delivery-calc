...
oz_pickup_provider_assert( str_contains( $pickup_rest_source, "'ozon_delivery' === \$carrier && '1' === \$this->param( \$request, 'progressive' )" ) && ! str_contains( $checkout_rest_source, 'ozon_delivery' ) && str_contains( $pickup_rest_source, 'registry_point_payload' ), 'Generic pickup REST must keep the normal provider projection and expose only an explicit narrow Ozon progressive transport branch.' );
