...
$builder = new PackagingBuilder( new PackagingBuilderConfig( $settings->tariff_default_weight_g(), $settings->tariff_default_length_cm(), $settings->tariff_default_width_cm(), $settings->tariff_default_height_cm(), $settings->tariff_default_declared_value_rub() ), new PackagingWeightCalculator( new SettingsRepository() ) );
