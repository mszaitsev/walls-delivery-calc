...
dpd_buttons_assert( str_contains( $metabox_source, 'if ( $is_cdek || $is_dpd )' ) && str_contains( $metabox_source, '$show_cancel = $has_created && $can_cancel' ), 'Initial metabox render must use DPD status payload for cancel button visibility.' );
