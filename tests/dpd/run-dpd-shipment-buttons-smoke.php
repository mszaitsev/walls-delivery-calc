...
dpd_buttons_assert( $created_payload['can_update_status'] && $created_payload['can_cancel'] && ! $created_payload['can_remove_from_order'], 'DPD status payload after create+1401 must show update/cancel and hide remove.' );
