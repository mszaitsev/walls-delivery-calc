...
pickup_checkout_assert( str_contains( $map_js, 'function preview(point, options)' ) && str_contains( $map_js, 'previewPoint = point' ) && str_contains( $map_js, 'confirmButton.disabled = !selectedPoint || pointId(selectedPoint) !== pointId(point)' ) && str_contains( $map_js, 'provider.openPointPopup(point, renderPointPopup(point' ), 'Initial/search preview must open a popup without enabling confirmation unless it is already the selected point.' );
