...
pickup_checkout_assert( str_contains( $checkout_js, "debug('updated_checkout skipped context refresh during place order'" ) && str_contains( $checkout_js, "window.jQuery(document.body).on('checkout_error', endPlaceOrder)" ), 'updated_checkout must not refresh checkout context while place_order is guarded; checkout_error releases the guard.' );
