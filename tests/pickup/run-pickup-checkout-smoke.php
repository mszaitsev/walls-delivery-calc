...
pickup_checkout_assert( ! str_contains( $rate_renderer_source, 'wdc-platform-pvz-selected' ) && ! str_contains( $rate_renderer_source, 'render_selected_pickup' ) && str_contains( $rate_renderer_source, 'render_pickup_selector' ) && str_contains( $rate_renderer_source, 'data-wdc-pickup-checkout' ), 'Checkout rate renderer must use the shared pickup selector instead of the legacy selected pickup summary/address block.' );
