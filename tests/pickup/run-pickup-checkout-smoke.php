...
pickup_checkout_assert( str_contains( $map_js, 'function pointMatchKeys(point)' ) && str_contains( $map_js, 'var snapshot = point && point.snapshot' ) && str_contains( $map_js, 'point && point.display_code' ) && str_contains( $map_js, 'snapshot.display_code' ) && str_contains( $map_js, 'snapshot.postcode' ) && str_contains( $map_js, 'snapshot.postal_code' ) && str_contains( $map_js, 'snapshot.point_postcode' ), 'Checkout selected Russian Post matching must include display_code/postcode fields from top-level and snapshot payloads.' );
