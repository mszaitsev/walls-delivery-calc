...
pickup_checkout_assert( str_contains( $map_js, "row.scrollIntoView({ behavior: 'smooth', block: 'nearest' });" ) && str_contains( $map_js, 'scrollListRowIntoView(point)' ), 'Marker/list preview must scroll the active row into the list viewport.' );
