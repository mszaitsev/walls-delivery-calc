...
pickup_checkout_assert( str_contains( $map_js, 'loadBounds(bboxAround(searchAddress.lat, searchAddress.lng))' ), 'Frontend must load a bbox around the found address after addressSearch.' );
