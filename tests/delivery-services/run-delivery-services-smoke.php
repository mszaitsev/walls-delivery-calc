...
wdc_ds_assert( str_contains( $delivery_admin_source, 'save_yandex_delivery_main_settings' ) && str_contains( $delivery_admin_source, 'sanitize_yandex_delivery_main_settings_from_post' ) && str_contains( $delivery_admin_source, 'YandexDeliverySettings::DEFAULT_PICKUP_METHOD_TITLE' ) && str_contains( $delivery_admin_source, 'YandexDeliverySettings::DEFAULT_COURIER_METHOD_TITLE' ), 'Yandex Delivery pickup/courier method titles must be configurable on the main tab.' );
