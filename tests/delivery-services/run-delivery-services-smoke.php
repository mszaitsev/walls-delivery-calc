...
wdc_ds_assert( $pek_service instanceof DeliveryService && array( 'RU' ) === $countries->countries( (int) $pek_service->id ), 'PEK service must bootstrap only RU availability on fresh setup.' );
