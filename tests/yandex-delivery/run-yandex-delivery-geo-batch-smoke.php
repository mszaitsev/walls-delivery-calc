...
yd_geo_batch_assert( str_contains( $admin_source, 'Массовый маппинг' ) && str_contains( $admin_source, 'Запустить обработку' ) && str_contains( $admin_source, 'Выполнить шаг' ) && str_contains( $admin_source, 'Пауза' ) && str_contains( $admin_source, 'Сбросить' ), 'Consolidated mapping tab must render Russian batch section labels.' );
