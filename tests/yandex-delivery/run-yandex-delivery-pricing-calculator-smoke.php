...
yandex_pricing_assert( 23790 === $rates[YandexDeliveryCarrier::PICKUP_RATE_ID]->price->get_kopecks() && 'Яндекс до ПВЗ' === $rates[YandexDeliveryCarrier::PICKUP_RATE_ID]->title && 7 === $rates[YandexDeliveryCarrier::PICKUP_RATE_ID]->delivery_days->min_days, 'Pickup checkout rate must use pricing response price and structured delivery days.' );
yandex_pricing_assert( 46360 === $rates[YandexDeliveryCarrier::COURIER_RATE_ID]->price->get_kopecks() && 'Яндекс до двери' === $rates[YandexDeliveryCarrier::COURIER_RATE_ID]->title && 9 === $rates[YandexDeliveryCarrier::COURIER_RATE_ID]->delivery_days->min_days, 'Courier checkout rate must use pricing response price and structured delivery days.' );
