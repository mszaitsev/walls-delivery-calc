...
$normalized_address_string = $success_service->normalize_detect_response( ( new LocationRepository( $GLOBALS['wpdb'] ) )->find_by_id( 10 ), 'query', array( 'body' => array( 'locations' => array( array( 'geo_id' => 2, 'address' => 'Новосибирск' ) ) ) ) );
