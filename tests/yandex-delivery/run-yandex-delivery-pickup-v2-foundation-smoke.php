...
yd_pickup_v2_assert( str_contains( $admin_source, "\$tabs['yandex_delivery_pickup'] = 'Яндекс ПВЗ/география';" ), 'Admin page must register the renamed Yandex pickup/geography tab.' );
