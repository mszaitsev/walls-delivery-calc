...
yd_geo_manual_assert( str_contains( $plugin_source, 'Version: 0.91.1' ) && str_contains( $plugin_source, "WDC_VERSION', '0.91.1" ), 'Plugin version must be 0.91.1.' );
yd_geo_manual_assert( str_contains( $project_status, '0.91.1 Yandex Geo Manual Region Cleanup Memory Safety' ), 'Project status must document manual region cleanup.' );
