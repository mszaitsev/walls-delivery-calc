...
yd_geo_pipeline_v2_assert( str_contains( $plugin_main, 'Version: 0.129.13' ) && str_contains( $plugin_main, "define( 'WDC_VERSION', '0.129.13' )" ), 'Plugin version must be 0.129.13.' );
