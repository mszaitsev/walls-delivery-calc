...
yd_geo_pipeline_v2_assert( str_contains( $plugin_main, 'Version: 1.0.18' ) && str_contains( $plugin_main, "define( 'WDC_VERSION', '1.0.18' )" ) && str_contains( $plugin_main, "define( 'WDC_SCHEMA_VERSION', '1.0.0' )" ), 'Plugin version must be 1.0.18 while the unchanged schema baseline remains 1.0.0.' );
