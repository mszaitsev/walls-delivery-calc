...
yd_geo_pipeline_v2_assert( str_contains( $plugin_main, 'Version: 0.128.17' ) && str_contains( $plugin_main, "define( 'WDC_VERSION', '0.128.17' )" ), 'Plugin version must be 0.128.17.' );
