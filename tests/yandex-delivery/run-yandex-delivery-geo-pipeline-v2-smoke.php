...
yd_geo_pipeline_v2_assert( str_contains( $plugin_main, 'Version: 0.135.11' ) && str_contains( $plugin_main, "define( 'WDC_VERSION', '0.135.11' )" ), 'Plugin version must be 0.135.11.' );
