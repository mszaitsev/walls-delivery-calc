...
The table is intentionally independent from checkout and legacy shipping code. As of `0.15.6`, production data is populated from a prepared GAR/ФИАС CSV instead of the old demo admin import.
