...
- `src/Carriers/Cdek/CdekSettings.php` stores the CDEK `shipment_point` setting with default `NSK69`; the admin CDEK main tab renders it near sender city settings.
