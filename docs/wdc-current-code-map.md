...
- `src/Shipments/YandexDelivery/YandexShipmentRegistrationService.php` reads only `meta['shipment_item_rows']` for canonical allocation rows. `yandex_item_rows` and `cdek_item_rows` are no longer production compatibility fallbacks.
