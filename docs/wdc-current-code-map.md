...
- `src/Core/Plugin.php` registers settings, replaceable HTTP client, API client, diagnostic service and Yandex pickup repository/normalizer/import/service. No Yandex checkout carrier, shipment adapter, cron, autosync, offers/create, offers/confirm, documents or status mapping are registered in 0.74.0.
