...
Старые GarSyncManager/GarChangesClient были заготовками до исследований: обнаружены несовпадения URL/методов с OpenAPI и отсутствие готового wiring авторизации/limiter. Они не запускались, не исправлялись и не удалялись. Наличие этих классов не означает, что исследование реализовало автообновление.
